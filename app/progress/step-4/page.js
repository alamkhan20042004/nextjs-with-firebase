        ...
        <div className="flex justify-center">
          <motion.button
            ...
            whileHover={{ 
              ...
              boxShadow: isButtonEnabled && !loading ? "0 20px 40px rgba(139, 92, 246, 0.3)" : "none"
            }}
            animate={{
            ...
            className={`px-8 py-4 font-bold rounded-full flex items-center justify-center gap-3 transform transition-all duration-200 ${
              isButtonEnabled && !loading
                ? "bg-gradient-to-r from-purple-600 to-indigo-600 shadow-lg cursor-pointer hover:shadow-purple-500/30"
                : "bg-gradient-to-r from-gray-600 to-gray-700 cursor-not-allowed"
            } ${buttonClicked ? 'ring-2 ring-purple-400 ring-opacity-50' : ''}`}
          >
            {loading ? (
              <>
                <svg
